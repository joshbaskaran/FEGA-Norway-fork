...
public class Heartbeat {
    ...
    @JsonProperty
    private Collection<Component> queues;
    @JsonProperty
    private Collection<Component> services;
    ...
    public static class Component {
        ...
        private Status status;
        @JsonProperty
        private LocalDateTime last_seen_ok = null;
        @JsonProperty
        private LocalDateTime last_seen_failed = null;
